...
namespace AppForSEII2526.UT.MaintenanceController_test
{
    public class GetMaintenance_test : AppForSEII25264SqliteUT
    {
        public GetMaintenance_test()
        {
            ...
            {
                new BookingItem() { Comment="Facil",Booking=bookings[0], Maintenance=maintenances[0],MaintName=maintenances[0].Name,Price=maintenances[0].Price, NumberOfDays = maintenances[0].NumberOfDays},
                new BookingItem() { Comment = "Dificil",Booking=bookings[1], Maintenance=maintenances[1],MaintName=maintenances[1].Name,Price=maintenances[1].Price, NumberOfDays = maintenances[1].NumberOfDays},
                new BookingItem() { Comment = "Intermedio",Booking=bookings[2], Maintenance=maintenances[2],MaintName=maintenances[2].Name,Price=maintenances[2].Price, NumberOfDays = maintenances[2].NumberOfDays}
            };
