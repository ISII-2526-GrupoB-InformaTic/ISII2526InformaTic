namespace AppForSEII2526.API.DTOs
{
    public class RentalDTO
    {
        ...
        public RentalDTO(int id, DateTime endDate, DateTime startDate, DateTime rentingDate,
            int totalPrice, string deliveryCarDealer, IList<RentalItemDTO> rentalItems, PaymentMethod paymentMethod)
        {
            Id = id;
            EndDate = endDate;
            StartDate = startDate;
